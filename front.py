...
class Track():
    def __init__(self, track_frame):
        ...
        self.recButton = customtkinter.CTkButton(master=self.master_frame, image=recordImg, text="", bg_color="#FFF", command=self.button_event)
        self.recButton.grid(row=6, column=0, columnspan=1, pady=20, padx=20, sticky="we")

        self.stopButton = customtkinter.CTkButton(master=self.master_frame, image=stopImg, text="", command=self.button_event)
        self.stopButton.grid(row=6, column=1, columnspan=1, pady=20, padx=20, sticky="we")
 
        self.saveButton = customtkinter.CTkButton(master=self.master_frame, image=saveImg, text="",command=self.button_event)
        ...
        self.combobox_1 = customtkinter.CTkComboBox(master=self.master_frame,
                                                    values=[ "Device 1", "Device 2"], command=self.button_event)
...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.addButton = customtkinter.CTkButton(master=self.frame_right, image=addImg, text="", bg_color="#FFF", command=self.add_track)
        ...
        self.deleteButton = customtkinter.CTkButton(master=self.frame_right, image=deleteImg, text="", bg_color="#FFF", command=self.delete_track)
